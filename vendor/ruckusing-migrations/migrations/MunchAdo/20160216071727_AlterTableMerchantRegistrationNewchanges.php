...
class AlterTableMerchantRegistrationNewchanges extends Ruckusing_Migration_Base
{
    public function up()
    {
        ...
        // $this->execute("ALTER TABLE `merchant_registration` CHANGE `expired_on` `expires_on` DATETIME NULL DEFAULT NULL");
        ...
        // $this->execute("ALTER TABLE  `merchant_registration` ADD  `campaign_start_date` DATETIME NULL AFTER  `expires_on`");
        // $this->execute("ALTER TABLE  `merchant_registration` ADD  `waiving_period` TINYINT NULL AFTER  `plan_period`");
    }//up()
