...
class InsertPointSourcedetailstructuredata extends Ruckusing_Migration_Base
{
    public function up()
    {
        $this->execute("INSERT IGNORE INTO `point_source_detail` (`id`, `name`, `points`, `csskey`, `identifier`, `created_at`, `points_for`, `dindex`, `dstatus`) VALUES
    ...
    (47, 'Redeem', 0, 'i_redemption', 'i_redemption', '2015-10-21 12:34:56', 'ws', 29, '1')");
    }//up()
