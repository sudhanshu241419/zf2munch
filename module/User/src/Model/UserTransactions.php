...
class UserTransactions extends AbstractModel
{
    ...
    public function getUserReferralEarning($user_id){
        $this->getDbTable()->setArrayObjectPrototype('ArrayObject');
        $options = array(
            'columns' => array('earning' => new \Zend\Db\Sql\Expression("SUM(transaction_amount)") ),
            'where' => array('user_id' => $user_id, 'category' => 2, 'transaction_type' => 'credit')
        );
